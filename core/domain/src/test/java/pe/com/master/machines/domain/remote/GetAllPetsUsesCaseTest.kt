...
class GetAllPetsUsesCaseTest {
    ...
    private val petsEntityDataRepository: PetsEntityDataRepository = mock()
    ...
    fun setup() {
        ...
        useCase = GetAllPetsUsesCase(petsNetworkDataRepository, petsEntityDataRepository)
    }
    ...
    fun `when local data is success and not empty, emits local data`() = runTest {
        ...
        whenever(petsEntityDataRepository.getAllPetsLocal())
    ...
    fun `when local data is error, fetches remote and saves`() = runTest {
        ...
        whenever(petsEntityDataRepository.savePets(remotePets))
        ...
        verify(petsEntityDataRepository).savePets(remotePets)
    }
